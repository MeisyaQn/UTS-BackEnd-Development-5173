<x-app-layout>
    ...
    <div class="py-12 bg-info" style="--bs-bg-opacity: .15; background-color: #cff4fc;"> {{-- Menggunakan BG-INFO (Biru Muda) dengan opacity rendah --}}
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8 space-y-6"> 
            ...
            {{-- Form Card --}}
            <div class="p-6 sm:p-8 bg-white shadow-lg rounded-lg border border-info"> {{-- Form dengan border biru muda (Info) --}}
                
                {{-- Judul Form --}}
                <h3 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-3 text-dark" style="border-color: #0dcaf0 !important;">Detail Produk Baru</h3>
